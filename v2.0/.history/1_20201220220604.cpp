...
{
    LinkList s;
	char n,c[10000],c1[10000],c2[10000];
    int c3;
	int flag=1;
 	while(flag)   
	{
...
int lend(LinkList &L,char nu[10000],int i)  //通过书号借阅书籍
{
    LinkList pre;
	int k;
	pre=L;
...
int lend1(LinkList &L,char nam[10000],int i) //通过书名借出书籍
{
    LinkList pre;
	int k;
	pre=L;
...
int lend2(LinkList L,char aut[10000],int i) //通过作者借出书籍
{
    LinkList pre,pre2;
	int k,b,g=0;
	pre=L;
...
int returnb(LinkList &L,char nu[10000],int i) //通过书号归还书籍
{
    LinkList pre;
	int k;
	pre=L;
...
int returnb1(LinkList &L,char nam[10000],int i) //通过书名归还书籍
{
    LinkList pre;
	int k;
	pre=L;
...
int returnb2(LinkList &L,char aut[10000],int i) //通过作者归还书籍
{
    LinkList pre,pre2;
	int k,b,g;
	pre=L;
