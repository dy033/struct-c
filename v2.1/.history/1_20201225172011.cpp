...
int userdataw(LinkList &L, int r3) //存储用户借阅所有书籍数据
{
    ...
    while (pre != NULL)
    {
        ...
        if (!strcmp(pre->num, inf[r3].booknum[inf[r3].bookn]))
        {
            ...
            fprintf(fp, "%d %s %d %d %d %d", inf[r3].booknu, inf[r3].booknum[inf[r3].bookn], inf[r3].booknu[inf[r3].bookn], inf[r3].y[inf[r3].bookn], inf[r3].m[inf[r3].bookn], inf[r3].d[inf[r3].bookn]);
            flag3++;
        }
...
int userdatar(int r3) //读取用户借阅所有书籍数据
{
    ...
    while (!feof(fp))
    {
        fscanf(fp, "%d%s%d%d%d%d", inf[r3].booknu, inf[r3].booknum[bookn], &inf[r3].booknu[bookn], &inf[r3].y[bookn], &inf[r3].m[bookn], &inf[r3].d[bookn]);
        // bookn++;
    }
    fclose(fp);
    return 1;
